            ...
            Pass{
                ...
                CGPROGRAM
                    ...
                    fixed4 frag(v2f i) : COLOR{//SV_Target{
                        ...
                        //Ambient light
                        float3 ambientLighting = (_Ka.r + _Ka.g + _Ka.b) / 3 * float3(1, 1, 1) /** UNITY_LIGHTMODEL_AMBIENT.rgb * _Color.rgb*/;
                        //Diffuse light
                        float3 diffuseReflection = (_Kd.r + _Kd.g + _Kd.b) / 3 * float3(1, 1, 1) /** _LightColor0.rgb * _Color.rgb*/ * max(0.0, dot(normalDirection, lightDirection));
                        //Specular light
                        ...
                        if (dot(normalDirection, lightDirection) < 0.0) {
                            ...
                            specularReflection = (_Ks.r + _Ks.g + _Ks.b) / 3 * float3(1, 1, 1) /** _LightColor0.rgb * _SpecColor.rgb*/ * pow(max(0.0, dot(reflectDirection, viewDirection)), _Shininess);
                        }
